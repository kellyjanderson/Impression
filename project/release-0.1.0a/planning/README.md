...
Agent directive cleanup planning lives in:

- [`agent-directive-consistency-plan.md`](agent-directive-consistency-plan.md)
- [`specification-manifest-skill-template-audit.md`](specification-manifest-skill-template-audit.md)

Critical loft topology correspondence architecture lives in:

- [`../architecture/loft-topology-point-correspondence-architecture.md`](../architecture/loft-topology-point-correspondence-architecture.md)
