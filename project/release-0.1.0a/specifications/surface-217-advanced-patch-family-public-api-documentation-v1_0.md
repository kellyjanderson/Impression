# Surface Spec 217: Advanced Patch Family Public API Documentation (v1.0)

## Overview

Document the public authoring routes and examples for advanced patch families once they are integrated, so users do not rediscover raw patch payload rules.
