# Surface Spec 215: .impress Unsupported Family And Malformed Payload Diagnostics (v1.0)

## Overview

Ensure `.impress` rejects unsupported, unknown, or malformed family payloads without accepting partial surface truth.
