# Surface Spec 306: Displacement Evaluation And Tessellation Adapter (v1.0)

## Overview

Complete displaced point evaluation, derivative approximation, and bounded tessellation against the source patch domain.
...
This specification promotes the manifest candidate `Displacement Evaluation And Tessellation Adapter` into a final
implementation leaf.
...
- `Displacement Evaluation And Tessellation Adapter` is implemented in the owner/module named above
