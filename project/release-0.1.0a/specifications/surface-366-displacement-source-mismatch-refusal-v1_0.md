# Surface Spec 366: Displacement Source Mismatch Refusal (v1.0)

## Overview

Implement `Displacement Source Mismatch Refusal` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Displacement Source Mismatch Refusal` into a final implementation leaf.
...
Displacement Source Mismatch Refusal
...
- `Displacement Source Mismatch Refusal` is implemented in the owner/module named by the manifest candidate
