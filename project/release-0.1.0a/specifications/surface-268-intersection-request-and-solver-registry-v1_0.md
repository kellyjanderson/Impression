# Surface Spec 268: Intersection Request And Solver Registry (v1.0)
...
This specification promotes the manifest candidate `Intersection Request And Solver Registry` into a final implementation leaf.
...
- `Intersection Request And Solver Registry` is implemented in the owner/module named above
