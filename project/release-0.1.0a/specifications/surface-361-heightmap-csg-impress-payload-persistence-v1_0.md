# Surface Spec 361: Heightmap CSG Impress Payload Persistence (v1.0)

## Overview

Implement `Heightmap CSG Impress Payload Persistence` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Heightmap CSG Impress Payload Persistence` into a final implementation leaf.
...
Heightmap CSG Impress Payload Persistence
...
- `Heightmap CSG Impress Payload Persistence` is implemented in the owner/module named by the manifest candidate
