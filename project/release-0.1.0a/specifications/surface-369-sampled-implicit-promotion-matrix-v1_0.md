# Surface Spec 369: Sampled Implicit Promotion Matrix (v1.0)

## Overview

Implement `Sampled Implicit Promotion Matrix` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Sampled Implicit Promotion Matrix` into a final implementation leaf.
...
Sampled Implicit Promotion Matrix
...
- `Sampled Implicit Promotion Matrix` is implemented in the owner/module named by the manifest candidate
