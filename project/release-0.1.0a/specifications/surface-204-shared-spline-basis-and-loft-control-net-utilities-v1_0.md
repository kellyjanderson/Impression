# Surface Spec 204: Shared Spline Basis And Loft Control-Net Utilities (v1.0)

## Overview

Separate reusable B-spline/NURBS basis, knot, and control-net utility work from loft producer behavior so later producers do not hide math infrastructure.
