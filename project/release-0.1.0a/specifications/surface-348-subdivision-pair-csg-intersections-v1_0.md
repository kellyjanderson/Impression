# Surface Spec 348: Subdivision Pair CSG Intersections (v1.0)

## Overview

Implement `Subdivision Pair CSG Intersections` as a final surface-body CSG completion leaf.
...
This specification promotes the manifest candidate `Subdivision Pair CSG Intersections` into a final
implementation leaf.
...
Subdivision Pair CSG Intersections
...
- `Subdivision Pair CSG Intersections` is implemented in the owner/module named by the manifest candidate
