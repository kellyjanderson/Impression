# Surface Spec 193: .impress Heightmap Surface Patch Codec (v1.0)

## Overview

Persist and restore `HeightmapSurfacePatch` payloads without source-image or mesh-wrapper fallback.
