# Surface Spec 365: Displacement Offset Composition Operators (v1.0)

## Overview

Implement `Displacement Offset Composition Operators` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Displacement Offset Composition Operators` into a final implementation leaf.
...
Displacement Offset Composition Operators
...
- `Displacement Offset Composition Operators` is implemented in the owner/module named by the manifest candidate
