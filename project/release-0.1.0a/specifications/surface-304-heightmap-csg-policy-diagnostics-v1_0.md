# Surface Spec 304: Heightmap CSG Policy Diagnostics (v1.0)

## Overview

Classify heightmap CSG behavior as exact, adapter, unsupported, or non-CSG by operation/family pair with durable diagnostics.
...
This specification promotes the manifest candidate `Heightmap CSG Policy Diagnostics` into a final
implementation leaf.
...
- `Heightmap CSG Policy Diagnostics` is implemented in the owner/module named above
