# Surface Spec 342: Analytic To NURBS CSG Intersections (v1.0)

## Overview

Implement `Analytic To NURBS CSG Intersections` as a final surface-body CSG completion leaf.
...
This specification promotes the manifest candidate `Analytic To NURBS CSG Intersections` into a final
implementation leaf.
...
Analytic To NURBS CSG Intersections
...
- `Analytic To NURBS CSG Intersections` is implemented in the owner/module named by the manifest candidate
