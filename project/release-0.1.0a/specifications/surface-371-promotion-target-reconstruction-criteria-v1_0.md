# Surface Spec 371: Promotion Target Reconstruction Criteria (v1.0)

## Overview

Implement `Promotion Target Reconstruction Criteria` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Promotion Target Reconstruction Criteria` into a final implementation leaf.
...
Promotion Target Reconstruction Criteria
...
- `Promotion Target Reconstruction Criteria` is implemented in the owner/module named by the manifest candidate
