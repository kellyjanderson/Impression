# Surface Spec 358: Heightmap Composition Operators (v1.0)

## Overview

Implement `Heightmap Composition Operators` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Heightmap Composition Operators` into a final implementation leaf.
...
Heightmap Composition Operators
...
- `Heightmap Composition Operators` is implemented in the owner/module named by the manifest candidate
