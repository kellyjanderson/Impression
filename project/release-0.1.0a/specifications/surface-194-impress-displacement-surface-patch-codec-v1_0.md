# Surface Spec 194: .impress Displacement Surface Patch Codec (v1.0)

## Overview

Persist and restore `DisplacementSurfacePatch` payloads while preserving the nested source surface and sampled displacement truth.
