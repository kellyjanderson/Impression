# Surface Spec 364: Displacement Domain And Sample Resampling (v1.0)

## Overview

Implement `Displacement Domain And Sample Resampling` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Displacement Domain And Sample Resampling` into a final implementation leaf.
...
Displacement Domain And Sample Resampling
...
- `Displacement Domain And Sample Resampling` is implemented in the owner/module named by the manifest candidate
