# Surface Spec 189: Patch Family Availability Gate And Capability Matrix (v1.0)

## Overview

Define the testable gates that allow a patch family to move from `planned` to `available` without overstating partial support.
