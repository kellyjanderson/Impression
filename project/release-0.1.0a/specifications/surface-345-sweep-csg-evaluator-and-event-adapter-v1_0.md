# Surface Spec 345: Sweep CSG Evaluator And Event Adapter (v1.0)

## Overview

Implement `Sweep CSG Evaluator And Event Adapter` as a final surface-body CSG completion leaf.
...
This specification promotes the manifest candidate `Sweep CSG Evaluator And Event Adapter` into a final
implementation leaf.
...
Sweep CSG Evaluator And Event Adapter
...
- `Sweep CSG Evaluator And Event Adapter` is implemented in the owner/module named by the manifest candidate
