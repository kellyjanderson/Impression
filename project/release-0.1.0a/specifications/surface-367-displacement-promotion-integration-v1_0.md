# Surface Spec 367: Displacement Promotion Integration (v1.0)

## Overview

Implement `Displacement Promotion Integration` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Displacement Promotion Integration` into a final implementation leaf.
...
Displacement Promotion Integration
...
- `Displacement Promotion Integration` is implemented in the owner/module named by the manifest candidate
