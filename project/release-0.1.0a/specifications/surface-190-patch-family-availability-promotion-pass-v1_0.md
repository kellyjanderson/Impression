# Surface Spec 190: Patch Family Availability Promotion Pass (v1.0)

## Overview

Promote families from `planned` to `available` only after their integration evidence exists, and leave explicit diagnostics for any operation-scoped gaps.
