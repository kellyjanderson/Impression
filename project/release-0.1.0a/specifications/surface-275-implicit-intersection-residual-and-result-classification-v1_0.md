# Surface Spec 275: Implicit Intersection Residual And Result Classification (v1.0)
...
This specification promotes the manifest candidate `Implicit Intersection Residual And Result Classification` into a final implementation leaf.
...
- `Implicit Intersection Residual And Result Classification` is implemented in the owner/module named above
