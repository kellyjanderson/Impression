# Surface Spec 372: Promotion Persistence Coverage (v1.0)

## Overview

Implement `Promotion Persistence Coverage` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Promotion Persistence Coverage` into a final implementation leaf.
...
Promotion Persistence Coverage
...
- `Promotion Persistence Coverage` is implemented in the owner/module named by the manifest candidate
