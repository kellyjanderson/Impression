# Surface Spec 350: Sampled Implicit Unsupported Row Tracker (v1.0)

## Overview

Implement `Sampled Implicit Unsupported Row Tracker` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Sampled Implicit Unsupported Row Tracker` into a final implementation leaf.
...
Sampled Implicit Unsupported Row Tracker
...
- `Sampled Implicit Unsupported Row Tracker` is implemented in the owner/module named by the manifest candidate
