# Surface Spec 357: Heightmap Projection And Grid Alignment (v1.0)

## Overview

Implement `Heightmap Projection And Grid Alignment` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Heightmap Projection And Grid Alignment` into a final implementation leaf.
...
Heightmap Projection And Grid Alignment
...
- `Heightmap Projection And Grid Alignment` is implemented in the owner/module named by the manifest candidate
