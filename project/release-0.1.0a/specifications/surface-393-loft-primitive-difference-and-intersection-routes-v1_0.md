# Surface Spec 393: Loft Primitive Difference And Intersection Routes (v1.0)
...
Implement `Loft Primitive Difference And Intersection Routes` as a final reference CSG gap-closure leaf.
...
This specification promotes the manifest candidate `Loft Primitive Difference And Intersection Routes` into a final
implementation leaf.
...
Final manifest-derived implementation leaf. Current manifest score: 24.5. 2 readiness blocker(s) are carried as explicit implementation prerequisites. Split review result: Review for split. Cohesion reason: difference and intersection share cutter classification and patch mapping behavior for primitive cutters.
...
- `Loft Primitive Difference And Intersection Routes` is implemented in the owner/module named by the manifest
