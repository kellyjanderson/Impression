# Surface Spec 294: Shared Path Frame Transport Policy (v1.0)

## Overview

Define deterministic path frame transport, twist, scale, and orientation helpers reusable by sweep, loft rails, and future path extrusion.
...
This specification promotes the manifest candidate `Shared Path Frame Transport Policy` into a final
implementation leaf.
...
- `Shared Path Frame Transport Policy` is implemented in the owner/module named above
