# Surface Spec 347: Subdivision CSG Refined Chart Adapter (v1.0)

## Overview

Implement `Subdivision CSG Refined Chart Adapter` as a final surface-body CSG completion leaf.
...
This specification promotes the manifest candidate `Subdivision CSG Refined Chart Adapter` into a final
implementation leaf.
...
Subdivision CSG Refined Chart Adapter
...
- `Subdivision CSG Refined Chart Adapter` is implemented in the owner/module named by the manifest candidate
