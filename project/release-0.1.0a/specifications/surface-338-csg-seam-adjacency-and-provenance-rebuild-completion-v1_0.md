# Surface Spec 338: CSG Seam Adjacency And Provenance Rebuild Completion (v1.0)

## Overview

Implement `CSG Seam Adjacency And Provenance Rebuild Completion` as a final surface-body CSG completion leaf.
...
This specification promotes the manifest candidate `CSG Seam Adjacency And Provenance Rebuild Completion` into a final
implementation leaf.
...
CSG Seam Adjacency And Provenance Rebuild Completion
...
- `CSG Seam Adjacency And Provenance Rebuild Completion` is implemented in the owner/module named by the manifest candidate
