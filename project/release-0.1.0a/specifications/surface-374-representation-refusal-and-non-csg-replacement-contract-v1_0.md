# Surface Spec 374: Representation Refusal And Non-CSG Replacement Contract (v1.0)

## Overview

Implement `Representation Refusal And Non-CSG Replacement Contract` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Representation Refusal And Non-CSG Replacement Contract` into a final implementation leaf.
...
Representation Refusal And Non-CSG Replacement Contract
...
- `Representation Refusal And Non-CSG Replacement Contract` is implemented in the owner/module named by the manifest candidate
