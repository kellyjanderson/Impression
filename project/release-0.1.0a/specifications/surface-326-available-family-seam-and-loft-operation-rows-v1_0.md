# Surface Spec 326: Available-Family Seam And Loft Operation Rows (v1.0)

## Overview

Implement `Available-Family Seam And Loft Operation Rows` as a final surface-body availability or patch-family completion leaf.
...
This specification promotes the manifest candidate `Available-Family Seam And Loft Operation Rows` into a final
implementation leaf.
...
- `Available-Family Seam And Loft Operation Rows` is implemented in the owner/module named above
