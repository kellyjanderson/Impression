# Surface Spec 206: Loft B-Spline Control-Net Producer (v1.0)

## Overview

Build `BSplineSurfacePatch` payloads for smooth multi-station loft output using the shared spline utility boundary.
...
This specification promotes the manifest candidate `Loft B-Spline Control-Net Producer` into a final implementation leaf. It covers the behavior, data ownership, reuse boundary, and verification expectations needed to implement this leaf without returning to the architecture document for hidden decisions.
