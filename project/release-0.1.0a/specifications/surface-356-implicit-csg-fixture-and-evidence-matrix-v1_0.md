# Surface Spec 356: Implicit CSG Fixture And Evidence Matrix (v1.0)

## Overview

Implement `Implicit CSG Fixture And Evidence Matrix` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Implicit CSG Fixture And Evidence Matrix` into a final implementation leaf.
...
Implicit CSG Fixture And Evidence Matrix
...
- `Implicit CSG Fixture And Evidence Matrix` is implemented in the owner/module named by the manifest candidate
