# Surface Spec 198: Tessellation Adapter Capability Inventory And Metadata Gate (v1.0)

## Overview

Establish the authoritative tessellation adapter coverage matrix and require traceable metadata before families are considered tessellation-ready.
