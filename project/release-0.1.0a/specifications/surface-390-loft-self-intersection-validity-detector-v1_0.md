# Surface Spec 390: Loft Self-Intersection Validity Detector (v1.0)
...
Implement `Loft Self-Intersection Validity Detector` as a final reference CSG gap-closure leaf.
...
This specification promotes the manifest candidate `Loft Self-Intersection Validity Detector` into a final
implementation leaf.
...
Final manifest-derived implementation leaf. Current manifest score: 16.5. No readiness blockers are carried. Split review result: Review for split. Cohesion reason: the detector is one loft-validity gate with no fixture-schema responsibilities.
...
- `Loft Self-Intersection Validity Detector` is implemented in the owner/module named by the manifest
