# Surface Spec 359: Heightmap Representability And Refusal (v1.0)

## Overview

Implement `Heightmap Representability And Refusal` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Heightmap Representability And Refusal` into a final implementation leaf.
...
Heightmap Representability And Refusal
...
- `Heightmap Representability And Refusal` is implemented in the owner/module named by the manifest candidate
