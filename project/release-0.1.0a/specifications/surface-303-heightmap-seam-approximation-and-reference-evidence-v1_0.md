# Surface Spec 303: Heightmap Seam Approximation And Reference Evidence (v1.0)

## Overview

Complete heightmap sampled-boundary extraction, seam approximation metadata, negative seam diagnostics, and promoted reference evidence.
...
This specification promotes the manifest candidate `Heightmap Seam Approximation And Reference Evidence` into a final
implementation leaf.
...
- `Heightmap Seam Approximation And Reference Evidence` is implemented in the owner/module named above
