# Surface Spec 201: Subdivision Surface Tessellation Adapter (v1.0)

## Overview

Tessellate subdivision patches at the tessellation boundary with explicit approximation metadata and without mutating the authored control cage.
