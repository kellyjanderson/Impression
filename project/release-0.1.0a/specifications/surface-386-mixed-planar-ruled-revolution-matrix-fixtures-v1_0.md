# Surface Spec 386: Mixed Planar Ruled Revolution Matrix Fixtures (v1.0)
...
Implement `Mixed Planar Ruled Revolution Matrix Fixtures` as a final reference CSG gap-closure leaf.
...
This specification promotes the manifest candidate `Mixed Planar Ruled Revolution Matrix Fixtures` into a final
implementation leaf.
...
Final manifest-derived implementation leaf. Current manifest score: 23.5. No readiness blockers are carried. Split review result: Review for split. Cohesion reason: this is one intentionally small mixed analytic/ruled fixture matrix.
...
- `Mixed Planar Ruled Revolution Matrix Fixtures` is implemented in the owner/module named by the manifest
