# Surface Spec 360: Heightmap Promotion Integration (v1.0)

## Overview

Implement `Heightmap Promotion Integration` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Heightmap Promotion Integration` into a final implementation leaf.
...
Heightmap Promotion Integration
...
- `Heightmap Promotion Integration` is implemented in the owner/module named by the manifest candidate
