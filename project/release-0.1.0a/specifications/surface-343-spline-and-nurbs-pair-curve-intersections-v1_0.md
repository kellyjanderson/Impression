# Surface Spec 343: Spline And NURBS Pair Curve Intersections (v1.0)

## Overview

Implement `Spline And NURBS Pair Curve Intersections` as a final surface-body CSG completion leaf.
...
This specification promotes the manifest candidate `Spline And NURBS Pair Curve Intersections` into a final
implementation leaf.
...
Spline And NURBS Pair Curve Intersections
...
- `Spline And NURBS Pair Curve Intersections` is implemented in the owner/module named by the manifest candidate
