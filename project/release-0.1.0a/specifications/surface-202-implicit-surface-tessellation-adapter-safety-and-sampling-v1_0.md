# Surface Spec 202: Implicit Surface Tessellation Adapter Safety And Sampling (v1.0)

## Overview

Tessellate implicit patches only from bounded safe declarative fields, with explicit sampling metadata and diagnostics for unsafe or unbounded states.
