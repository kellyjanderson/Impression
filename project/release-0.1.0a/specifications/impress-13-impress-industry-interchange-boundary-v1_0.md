# Impress Spec 13: .impress Industry Interchange Boundary (v1.0)

## Overview

Define what `.impress` does and does not promise relative to STEP, IGES, STL, and imported mesh workflows.
