# Surface Spec 352: Implicit Operand Field Adapters (v1.0)

## Overview

Implement `Implicit Operand Field Adapters` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Implicit Operand Field Adapters` into a final implementation leaf.
...
Implicit Operand Field Adapters
...
- `Implicit Operand Field Adapters` is implemented in the owner/module named by the manifest candidate
