# Surface Spec 318: Implicit Unsafe Authoring Diagnostics (v1.0)

## Overview

Implement `Implicit Unsafe Authoring Diagnostics` as a final surface-body availability or patch-family completion leaf.
...
This specification promotes the manifest candidate `Implicit Unsafe Authoring Diagnostics` into a final
implementation leaf.
...
- `Implicit Unsafe Authoring Diagnostics` is implemented in the owner/module named above
