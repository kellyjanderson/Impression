# Surface Spec 368: Displacement CSG Persistence And Fixtures (v1.0)

## Overview

Implement `Displacement CSG Persistence And Fixtures` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Displacement CSG Persistence And Fixtures` into a final implementation leaf.
...
Displacement CSG Persistence And Fixtures
...
- `Displacement CSG Persistence And Fixtures` is implemented in the owner/module named by the manifest candidate
