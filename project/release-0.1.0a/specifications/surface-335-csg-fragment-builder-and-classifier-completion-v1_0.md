# Surface Spec 335: CSG Fragment Builder And Classifier Completion (v1.0)

## Overview

Implement `CSG Fragment Builder And Classifier Completion` as a final surface-body CSG completion leaf.
...
This specification promotes the manifest candidate `CSG Fragment Builder And Classifier Completion` into a final
implementation leaf.
...
CSG Fragment Builder And Classifier Completion
...
- `CSG Fragment Builder And Classifier Completion` is implemented in the owner/module named by the manifest candidate
