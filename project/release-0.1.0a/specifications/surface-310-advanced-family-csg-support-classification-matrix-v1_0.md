# Surface Spec 310: Advanced Family CSG Support Classification Matrix (v1.0)

## Overview

Define exact, declared-tolerance, adapter, unsupported, or non-CSG posture for every operation/family pair involving advanced patch families.
...
This specification promotes the manifest candidate `Advanced Family CSG Support Classification Matrix` into a final
implementation leaf.
...
- `Advanced Family CSG Support Classification Matrix` is implemented in the owner/module named above
