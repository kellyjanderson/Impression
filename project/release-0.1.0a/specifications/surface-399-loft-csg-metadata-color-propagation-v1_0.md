# Surface Spec 399: Loft CSG Metadata Color Propagation (v1.0)
...
Implement `Loft CSG Metadata Color Propagation` as a final reference CSG gap-closure leaf.
...
This specification promotes the manifest candidate `Loft CSG Metadata Color Propagation` into a final
implementation leaf.
...
Final manifest-derived implementation leaf. Current manifest score: 16.5. No readiness blockers are carried. Split review result: Review for split. Cohesion reason: metadata propagation is one CSG result provenance contract and has no fixture schema responsibilities.
...
- Rescore summary: manifest score remains 16.5; IWU count remains 1; child specifications remain none.
...
- `Loft CSG Metadata Color Propagation` is implemented in the owner/module named by the manifest
