# Surface Spec 363: Displacement Source Identity Resolution (v1.0)

## Overview

Implement `Displacement Source Identity Resolution` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Displacement Source Identity Resolution` into a final implementation leaf.
...
- `Displacement Source Identity Resolution` is implemented in the owner/module named by the manifest candidate
