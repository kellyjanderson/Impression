# Surface Spec 362: Heightmap CSG Fixture And Evidence Matrix (v1.0)

## Overview

Implement `Heightmap CSG Fixture And Evidence Matrix` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Heightmap CSG Fixture And Evidence Matrix` into a final implementation leaf.
...
Heightmap CSG Fixture And Evidence Matrix
...
- `Heightmap CSG Fixture And Evidence Matrix` is implemented in the owner/module named by the manifest candidate
