# Surface Spec 378: Sampled Implicit Dirty Evidence Rejection (v1.0)

## Overview

Implement `Sampled Implicit Dirty Evidence Rejection` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Sampled Implicit Dirty Evidence Rejection` into a final implementation leaf.
...
Sampled Implicit Dirty Evidence Rejection
...
- `Sampled Implicit Dirty Evidence Rejection` is implemented in the owner/module named by the manifest candidate
