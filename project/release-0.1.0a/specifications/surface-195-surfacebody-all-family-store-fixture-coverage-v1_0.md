# Surface Spec 195: SurfaceBody All-Family Store Fixture Coverage (v1.0)

## Overview

Prove `SurfacePatch -> SurfaceShell -> SurfaceBody` preserves every patch family as surface truth.
