# Surface Spec 370: Promotion Provenance And Lossiness Records (v1.0)

## Overview

Implement `Promotion Provenance And Lossiness Records` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Promotion Provenance And Lossiness Records` into a final implementation leaf.
...
Promotion Provenance And Lossiness Records
...
- `Promotion Provenance And Lossiness Records` is implemented in the owner/module named by the manifest candidate
