# Surface Spec 344: Spline And NURBS Coincident Region CSG Intersections (v1.0)

## Overview

Implement `Spline And NURBS Coincident Region CSG Intersections` as a final surface-body CSG completion leaf.
...
This specification promotes the manifest candidate `Spline And NURBS Coincident Region CSG Intersections` into a final
implementation leaf.
...
Spline And NURBS Coincident Region CSG Intersections
...
- `Spline And NURBS Coincident Region CSG Intersections` is implemented in the owner/module named by the manifest candidate
