# Surface Spec 354: Implicit Composition Operation Semantics (v1.0)

## Overview

Implement `Implicit Composition Operation Semantics` as a final sampled/implicit SurfaceBody CSG completion leaf.
...
This specification promotes the manifest candidate `Implicit Composition Operation Semantics` into a final implementation leaf.
...
Implicit Composition Operation Semantics
...
- `Implicit Composition Operation Semantics` is implemented in the owner/module named by the manifest candidate
