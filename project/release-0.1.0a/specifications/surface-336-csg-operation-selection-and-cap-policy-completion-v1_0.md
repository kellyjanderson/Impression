# Surface Spec 336: CSG Operation Selection And Cap Policy Completion (v1.0)

## Overview

Implement `CSG Operation Selection And Cap Policy Completion` as a final surface-body CSG completion leaf.
...
This specification promotes the manifest candidate `CSG Operation Selection And Cap Policy Completion` into a final
implementation leaf.
...
CSG Operation Selection And Cap Policy Completion
...
- `CSG Operation Selection And Cap Policy Completion` is implemented in the owner/module named by the manifest candidate
