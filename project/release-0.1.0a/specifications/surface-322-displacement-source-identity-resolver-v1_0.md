# Surface Spec 322: Displacement Source Identity Resolver (v1.0)

## Overview

Implement `Displacement Source Identity Resolver` as a final surface-body availability or patch-family completion leaf.
...
This specification promotes the manifest candidate `Displacement Source Identity Resolver` into a final
implementation leaf.
...
- `Displacement Source Identity Resolver` is implemented in the owner/module named above
