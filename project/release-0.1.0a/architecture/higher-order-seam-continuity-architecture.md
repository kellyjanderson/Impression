...
### Candidate Spec: Higher-Order Continuity Validation And Violation Locators

Discovery purpose:
- Validate C1/C2/G1/G2 requests and report exact locations of failures along
  seams.
...
- Test strategy:
  - positive C1/G1 fixtures and negative localized violation fixtures
- Data ownership:
...
Split decision:
- Review for split. Cohesion reason: validation and locator diagnostics are one
  user-facing report contract; enforcement is split separately.
