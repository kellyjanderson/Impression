...
- Test strategy: displacement source identity tests; source-domain compatibility tests; negative diagnostic fixture coverage; no-hidden-mesh-fallback tests for refused routes
