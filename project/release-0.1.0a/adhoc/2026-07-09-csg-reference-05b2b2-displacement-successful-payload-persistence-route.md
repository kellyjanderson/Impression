...
- Test strategy: child-leaf successful/promoted displacement result tests; child-leaf displacement payload round-trip tests; child-leaf result provenance tests; child-leaf no-hidden-mesh-fallback tests
