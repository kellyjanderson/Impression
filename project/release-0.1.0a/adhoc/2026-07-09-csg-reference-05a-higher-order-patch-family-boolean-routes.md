...
- Test strategy: support matrix tests for every listed family; execute-or-refuse tests for representative operation classes; residual/tolerance diagnostics for declared-tolerance routes; no-hidden-mesh-fallback tests
