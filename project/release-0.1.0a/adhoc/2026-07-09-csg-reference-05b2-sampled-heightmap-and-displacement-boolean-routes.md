...
- Test strategy: child-leaf route preservation/promotion/refusal tests; child-leaf `.impress` round-trip tests for successful/promoted sampled payloads; child-leaf no-hidden-mesh-fallback tests
