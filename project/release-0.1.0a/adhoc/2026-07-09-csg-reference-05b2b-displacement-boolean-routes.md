...
Count: 3 IWU.
Basis: parent program document with three final 1-IWU descendant leaves: source identity/refusal, result construction, and payload persistence evidence.
...
- Split completed. This parent is not an implementation leaf; implementation
  lives in final descendant leaves Specs 05b2b1, 05b2b2a, and 05b2b2b,
  with Spec 05b2b2 retained only as a nested program document.
