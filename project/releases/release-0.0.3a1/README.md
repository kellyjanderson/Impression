...
At release time, this was represented by the following project architecture
documents:

- `project/architecture/surface-mesh-decommission-architecture.md`
- `project/architecture/testing-architecture.md`
- `project/architecture/model-output-reference-verification.md`
- `project/architecture/computer-vision-verification-architecture.md`
...
The detailed execution order at release time was tracked in
