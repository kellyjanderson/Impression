...
from .loft import (
    ...
    loft_plan_sections,
    resolve_exact_region_identity_pairs,
    construct_residual_region_transition,
    validate_synthetic_station_lineage,
...
from .csg import (
    ...
    SurfaceCSGBodyRouteEvidenceAuditRow,
    ...
    SurfaceCSGCoincidenceToleranceRecord,
    ...
    SurfaceSampledImplicitDirtyEvidenceDiagnostic,
    ...
    build_underconstrained_branch_diagnostic,
    ...
    compare_surface_difference_geometry,
    normalize_surface_difference_evidence,
    classify_surface_difference_no_cut,
    ...
    validate_geometry_change_witness,
    ...
    build_unsupported_loft_pairing_diagnostic,
    build_loft_primitive_no_hidden_mesh_proof,
    build_loft_difference_intersection_evidence,
    build_loft_difference_patch_pair_candidates,
